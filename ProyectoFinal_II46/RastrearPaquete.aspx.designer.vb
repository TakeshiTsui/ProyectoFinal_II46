...
Partial Public Class RastrearPaquete

    '''<summary>
    '''Control txtNumeroPaquete.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents txtNumeroPaquete As Global.System.Web.UI.WebControls.TextBox
    ...
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents btnRastrear As Global.System.Web.UI.WebControls.Button
