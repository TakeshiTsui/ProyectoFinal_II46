...
Public Class dbLogin
    ...
    Public Function GetUser(usuario As String) As Object
        ...
        Dim dt As DataTable = dbHelper.ExecuteQuery(sql, Parametros) 'ejecuta la consulta y retorna un datatable
        Dim UsuarioObj As New Usuario()
        If dt.Rows.Count > 0 Then 'verifica si se encontro el usuario
